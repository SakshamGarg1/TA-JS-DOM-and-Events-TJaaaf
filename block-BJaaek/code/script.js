let dabba = document.querySelector(".boxOne");
let bg1= document.querySelector(".boxTwo");
...
function handleClick(){ 
   ...
   dabba.style.backgroundColor = randomColor;
}
...
bg1.addEventListener("mousemove", handleMouseMove);
